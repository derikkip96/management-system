                                    ...
                                    <tbody>
                                      @foreach ($leave as $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->MD }}</td>
                                            <td>
                                                <button class="btn btn-sm btn-success" onclick="approve({{ $value->userId }}, {{ "'$value->created_at'" }}, 1)" >Approve</button>
                                                <button class="btn btn-sm btn-danger" onclick="approve({{ $value->userId }}, {{ "'$value->created_at'" }}, 0)" >Deny</button>
                                            </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
